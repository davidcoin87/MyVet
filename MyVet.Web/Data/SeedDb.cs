...
namespace MyVet.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckRoles();
            var manager = await CheckUserAsync("1010", "David", "Ruiz", "darupa122@gmail.com", "3162980992", "Calle Luna Calle Sol", "Admin");
            var customer = await CheckUserAsync("2020", "David", "Ruiz", "darupa_122@hotmail.com", "3162980992", "Calle Luna Calle Sol", "Customer");
        ...
        private async Task<User> CheckUserAsync(
            string document, string firstName, string lastName, string email, 
            string phone, string address, string role)
        {
            ...
            if (user == null)
            {
                ...
                await _userHelper.AddUserAsync(user, "Dz2468**");
